...
jq -c '.expiration=$tx_delay | .ref_block_num=0 | .ref_block_prefix=0' --arg tx_delay "$tx_delay" 3_04_sudo_update_tester_owner_trx.json | jq . > 3_05_sudo_update_tester_owner_trx.json
